 ...
 *  Si => le food recuperé, snakelongueur++ et  Score++
 *  Si => le snake hurte son propre corp/"bordure du screen" à une lapse de temps 
 *          => mort
 ...
 * - State => Snake (isDead), Food (isMangé), Jeu (isfinish)
